...
if [ -d /proc/sys/walt ]; then
	...
	echo 633600 > /sys/devices/system/cpu/cpufreq/policy2/walt/rtg_boost_freq
	echo 633600 > /sys/devices/system/cpu/cpufreq/policy5/walt/rtg_boost_freq
	...
	echo 883200 > /sys/devices/system/cpu/cpufreq/policy0/walt/hispeed_cond_freq
	echo 940800 > /sys/devices/system/cpu/cpufreq/policy2/walt/hispeed_cond_freq
	echo 940800 > /sys/devices/system/cpu/cpufreq/policy5/walt/hispeed_cond_freq
	echo 480000 > /sys/devices/system/cpu/cpufreq/policy7/walt/hispeed_cond_freq
else
